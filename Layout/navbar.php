                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false" >
                    <a href="javascript:;" class="group relative" @click="toggle()">
                        <span class="flex items-center gap-2">
                            <span class="block rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60">
                                <svg
                                        width="20"
                                        height="20"
                                        viewBox="0 0 24 24"
                    ...
                    <ul
                        ...
                        class="top-11 rounded-lg w-[230px] !py-0 font-semibold text-dark ltr:right-0 rtl:left-0 dark:text-white-dark dark:text-white-light/90"
                    >
                        <li class="bg-gradient-to-r from-[#4361ee] to-[#160f6b] text-white">
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <span class="block rounded-lg bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60">        
                                        <svg
                                            width="20"
                                            height="20"
                                            viewBox="0 0 24 24"
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <a href="seguridad/cerrarSesion.php" class="!py-3 text-danger" @click="toggle">
                                <svg
