                        ...
                        <div class="pt-5">
                            ...
                            <div class="mb-6 grid gap-6 sm:grid-cols-6 xl:grid-cols-6" >
                                <div class="panel h-full pb-0 sm:col-span-6 xl:col-span-6" >
                                    <h5 class="mb-5 text-lg font-semibold dark:text-white-light">Datos de la Persona</h5>
                                    ...
                                    <div class="perfect-scrollbar relative mb-4 -mr-3 pr-3">
                                        <div class="cursor-pointer text-sm">
                                            <div class="group relative flex items-center py-1.5">
                                                <div class="flex-1">C.I.:</div>
                                                <div class="text-xs text-white-dark ltr:ml-auto rtl:mr-auto dark:text-gray-500">22921565</div>
                                            </div>
                                            <div class="group relative flex items-center py-1.5">
                                            ...
                                            <div class="group relative flex items-center py-1.5">
                                                ...
                                                <div class="text-xs text-white-dark ltr:ml-auto rtl:mr-auto dark:text-gray-500">PEDRO CLEMENTE</div>
                                            </div>
                                            <div class="group relative flex items-center py-1.5">
                                                <div class="flex-1">NÚCLEO:</div>
                                                <div class="text-xs text-white-dark ltr:ml-auto rtl:mr-auto dark:text-gray-500">RECTORADO</div>
                                            </div>
                                            <div class="group relative flex items-center py-1.5">
                                                <div class="flex-1">TIPO PERSONAL:</div>
                                                <div class="text-xs text-white-dark ltr:ml-auto rtl:mr-auto dark:text-gray-500">ADMINISTRATIVO</div>
                                            </div>
                                            <div class="group relative flex items-center py-1.5">
                                                <div class="flex-1">CONDICIÓN LABORAL:</div>
                                                <div class="text-xs text-white-dark ltr:ml-auto rtl:mr-auto dark:text-gray-500">SUPERNUMERARIO</div>
                                            </div>
