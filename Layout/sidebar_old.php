                        ...
                        <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto low-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'dashboard' }">
                                    ...
                                    <li class="nav-item">
                                        <a href="apps-todolist.html" class="group">
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">FP-OIO</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <li class="menu nav-item">
                                ...
                                <ul x-cloak x-show="activeDropdown === 'datatables'" x-collapse class="sub-menu text-gray-500">
                                    <li>
                                        <a href="datatables-basic.html">INTERNO DOCENTES</a>
                                    </li>
                                    <li>
                                        <a href="datatables-advanced.html">INTERNO ADMINISTRATIVOS</a>
                                    </li>
                                    <li>
                                        <a href="datatables-skin.html">INTERNO OBREROS</a>
                                    </li>
                                    <li>
                                        <a href="datatables-order-sorting.html">OPSU</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="menu nav-item">
